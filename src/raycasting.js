...
<tbody>
  ...
  <td>
    <input class="flag"  data-name="transfer" type="checkbox" checked="checked">
  </td>
</tr>
</tbody>
</table>
...
//// changed background , border added, borderRadius added
widgetContainer.style.background = 'black';
widgetContainer.style.border = '4px solid #a64d79';
...
////////////////////////////////////////////////////////////// ADDED (Top left widget controls) //////////////////////////////////////
...
function updateFlag(e) {
  ...
  //-------- Toggle of the transfer function ------------------//

  if (name=='transfer' && e.target.checked==false)
  {
    widgetContainer.style.display = 'none';
    labelContainer.style.display = 'none';
    console.log('hide');
  }
  else if (name=='transfer' && e.target.checked==true)
  {
    widgetContainer.style.display = 'flex';
